...
<tr>
  <td style="text-align: right">
    <a href="https://raw.githubusercontent.com/statmike/vertex-ai-mlops/main/Applied%20ML/Solution%20Prototypes/readme.md"><img src="https://www.svgrepo.com/download/5445/download-button.svg" alt="Download icon" width="20px"></a> <a href="https://raw.githubusercontent.com/statmike/vertex-ai-mlops/main/Applied%20ML/Solution%20Prototypes/readme.md">Download File</a> <i>(right-click and "Save As")</i>
  </td>
</tr>
</table><br/><br/>
...
- **[Product Hierarchy](./product-hierarchy/README.md)** - Classify new products into a Department → Category taxonomy using nine approaches across three paradigms
  - **[Notebook 1 — Python-First](./product-hierarchy/product-hierarchy.ipynb)**: Synthetic data generated by Gemini, all approaches implemented in Python
  - **[Notebook 2 — SQL-First (BigQuery)](./product-hierarchy/product-hierarchy-bq.ipynb)**: Real data (~29K products from thelook_ecommerce), SQL wherever possible using `AI.EMBED`, `VECTOR_SEARCH`, and `CREATE MODEL`, plus distributed Levenshtein via Dataproc Serverless Spark
  - **Flat Classification** (Approaches 1-4): Levenshtein distance (Spark), semantic embedding nearest neighbor, centroid matching, and gradient boosting
  - **Local Classifiers** (Approaches 5-7): Top-down hierarchical classification with cascading department → category classifiers
  - **Multi-Task Learning** (Approaches 8-9): Keras neural networks with shared layers — independent heads vs. conditional category head
  - **Comparison**: Side-by-side results across all nine approaches with discussion of when to use each paradigm
  - **Bonus — BQML Serving**: Export Keras MTL models as TensorFlow SavedModel, import into BigQuery, and serve predictions with `ML.PREDICT`
