...
places_of_interest_prompt = """
        ...
        **Step 2: Write and Execute SQL**
        - After you have the table schema, use the user's original question and the column information to write a precise BigQuery SQL query referencing the `vertexai-demo-ltfpzhaw.bq_adk_ds.attractions` table only.
