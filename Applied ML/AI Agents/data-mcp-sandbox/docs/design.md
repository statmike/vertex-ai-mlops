...
| **The published Path 4 result partly describes the wrapper.** | Probed 2026-09-07 and re-scored 2026-09-13. Same service, same corpus, same model, transport the only difference: **10.3s against 32.8s** median at tier 1, and on the nine gradeable questions **44/45 against 45/45** — the latency gap is large, the accuracy gap is one cell. The 13-point accuracy gap this row reported until 2026-09-13 was entirely the three anchor-ambiguous questions and is withdrawn. Latency is still enough to mean a Path 4 row measured through Toolbox's tool is a property of the tool as much as of Conversational Analytics. This was the finding most worth having and least worth wanting; it is why both arms exist. |
