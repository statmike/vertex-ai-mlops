...
agent_instructions = """
You answer questions about data meaning and documentation using two tools:
...
5. **Multiple searches**: For broad questions, call `search_context` multiple
   times with different queries to get comprehensive results. For example,
   "What reference tables exist?" could be searched as "reference table",
   "lookup table", "mapping table", and "ID table".
