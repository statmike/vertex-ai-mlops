# Helper functions for the Conversational Analytics API.
# Adapted from concept-bq/agent_convo_api/tools/utils/conversational_analytics_api_helpers.py
#
# Reference: https://cloud.google.com/gemini/docs/conversational-analytics-api/build-agent-sdk
