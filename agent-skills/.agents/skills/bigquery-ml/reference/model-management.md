...
- [`narrative/data_quality.md`](../narrative/data_quality.md) (source: `functions/data_quality/`) — all four data validation/drift functions on census_adult_income; also used as the conditional-retrain trigger in pipelines/
