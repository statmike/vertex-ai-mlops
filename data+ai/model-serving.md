![tracker](https://us-central1-vertex-ai-mlops-369716.cloudfunctions.net/pixel-tracking?path=statmike%2Fvertex-ai-mlops%2Fdata%2Bai&file=model-serving.md)
<!--- header table --->
<table>
<tr>     
  <td style="text-align: center">
    <a href="https://github.com/statmike/vertex-ai-mlops/blob/main/data%2Bai/model-serving.md">
...
<tr>
  <td style="text-align: right">
    <b>Share On: </b> 
    <a href="https://www.linkedin.com/sharing/share-offsite/?url=https://github.com/statmike/vertex-ai-mlops/blob/main/data%252Bai/model-serving.md"><img src="https://upload.wikimedia.org/wikipedia/commons/8/81/LinkedIn_icon.svg" alt="Linkedin Logo" width="20px"></a> 
    <a href="https://reddit.com/submit?url=https://github.com/statmike/vertex-ai-mlops/blob/main/data%252Bai/model-serving.md"><img src="https://redditinc.com/hubfs/Reddit%20Inc/Brand/Reddit_Logo.png" alt="Reddit Logo" width="20px"></a> 
    <a href="https://bsky.app/intent/compose?text=https://github.com/statmike/vertex-ai-mlops/blob/main/data%252Bai/model-serving.md"><img src="https://upload.wikimedia.org/wikipedia/commons/7/7a/Bluesky_Logo.svg" alt="BlueSky Logo" width="20px"></a> 
    <a href="https://twitter.com/intent/tweet?url=https://github.com/statmike/vertex-ai-mlops/blob/main/data%252Bai/model-serving.md"><img src="https://upload.wikimedia.org/wikipedia/commons/5/5a/X_icon_2.svg" alt="X (Twitter) Logo" width="20px"></a> 
  </td>
</tr>
<tr>
  <td style="text-align: right">
...
<tr>
  <td style="text-align: right">
    <a href="https://raw.githubusercontent.com/statmike/vertex-ai-mlops/main/data%2Bai/model-serving.md"><img src="https://www.svgrepo.com/download/5445/download-button.svg" alt="Download icon" width="20px"></a> <a href="https://raw.githubusercontent.com/statmike/vertex-ai-mlops/main/data%2Bai/model-serving.md">Download File</a> <i>(right-click and "Save As")</i>
  </td>
</tr>
</table><br/><br/>
...
**[View the complete guide to Google Cloud Databases →](gcp-databases.md)**
...
| | **Dataproc Serverless**<br><br>Spark-based batch and streaming | Pandas UDF<br>(Batch) | [Batch Inference](dataproc/examples/dataproc-batch-inference.ipynb)<br>• PySpark Pandas UDF with model caching<br>• BigQuery I/O via Spark connector<br>• Runtime 2.2 (ML libs pre-installed) |
| | | Pandas UDF<br>(Streaming) | [Structured Streaming](dataproc/examples/dataproc-structured-streaming.ipynb)<br>• `readStream`/`writeStream` with foreachBatch<br>• Provisioned Dataproc cluster<br>• Near-real-time ML inference |
| | | Vertex Endpoint<br>(Batch) | [Spark + Vertex AI Endpoint](dataproc/examples/dataproc-vertex-ai-endpoint.ipynb)<br>• Call endpoint from Pandas UDF<br>• No ML libs needed on workers<br>• Centralized model management |
