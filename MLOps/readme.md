...
| [Feature Store](./Feature%20Store/readme.md) | 24 | Feature management with three approaches: [Vertex AI Feature Store](./Feature%20Store/vertex/readme.md) (6 notebooks — managed sync, feature registry, embeddings), [Bigtable Feature Store](./Feature%20Store/Bigtable/readme.md) (15 notebooks — direct writes, streaming, replication, vectors, recommendation engine) ([slide deck](./Feature%20Store/Bigtable/Bigtable%20Feature%20Store%20-%20Overview.pdf)), and [BigQuery Feature Store](./Feature%20Store/BigQuery/readme.md) (3 notebooks — Storage Read API, session caching, async serving, concurrency scaling, built-in governance via Dataplex, three-way latency comparison, Cloud Run deployment with combined-restriction batch optimization, sustained load testing, traffic splitting) ([slide deck](./Feature%20Store/BigQuery/BigQuery%20Feature%20Store%20-%20Overview.pdf)) |
