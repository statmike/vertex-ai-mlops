...
async def predict(request: Request):
    ...
    # Handle both flat strings (direct calls) and structured objects
    # (Spanner ML sends {"text": "value"} per instance based on INPUT schema)
    texts = [
        inst if isinstance(inst, str) else inst['text']
